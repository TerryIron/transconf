...
.controller('StockCtrl', ['$scope', function($scope) {// 路径配置
  ...
  require(
      ...
      function (ec) {
          ...
          var option_k = buildKLineOptions('111111', axisData, k);
          myChart_k.setOption(option_k);
          var myChart_a = ec.init(document.getElementById('stock_a'));
          var option_a = pluginAverageOptions(axisData, a);
          myChart_a.setOption(option_a);
          var myChart_s = ec.init(document.getElementById('stock_s'));
          var option_s = pluginSizeOptions(axisData, a);
